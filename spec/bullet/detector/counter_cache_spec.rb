    ...
    describe CounterCache do
      ...
      context ".conditions_met?" do
        it "should be true when object is possible, not impossible" do
          ...
          expect(CounterCache.send(:conditions_met?, @post1.bullet_ar_key, :associations)).to be_true
        end

        it "should be false when object is not possible" do
          expect(CounterCache.send(:conditions_met?, @post1.bullet_ar_key, :associations)).to be_false
        end
