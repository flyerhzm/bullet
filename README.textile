...
** Bullet::Association.logger (optional), if logger is true (default is true), the N+1 query hints will be appended to log/bullet.log. Otherwise, no hint to log/bullet.log.
